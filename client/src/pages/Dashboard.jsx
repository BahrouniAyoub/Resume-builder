import { FilePenIcon, PlusIcon, UploadCloudIcon, TrashIcon, PencilIcon, XIcon, UploadCloud } from 'lucide-react'
...
const Dashboard = () => {
  ...
  const colors = ["#933ea0", "#d97706", "#dc2626", "#0284c7", "#16a34a"]
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto py-8 px-4" >
        <p className="text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden" >Welcome, Adem</p>
